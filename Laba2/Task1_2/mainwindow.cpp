...
bool MainWindow::check_corect_file(int row, QString str)
{
    ...
    if(row % 10 == 1 && str.size() <= 15 && !str.isEmpty()) return true;
    else if(row % 10 == 2 && str.size() <= 15  && !str.isEmpty()) return true;
    else if(row % 10 == 3 && str.size() <=15  && !str.isEmpty()) return true;
    else if(row % 10 == 4 && str.size() <= 15  && !str.isEmpty()) return true;
    else if(row % 10 == 5 && str.size() <= 15  && !str.isEmpty()) return true;
